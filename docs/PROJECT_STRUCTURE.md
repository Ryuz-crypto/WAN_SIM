...
Version 2.0.12-rev3 keeps `WANsim2.sh` as the V1 entrypoint while `install-v2.sh` manages the stable V2 platform. The previous stable release remains available as `v1.119-stable`.
