...
`v2.0.12-rev2` es la ruta recomendada para instalaciones nuevas. Conserva el respaldo y la referencia V1.119 hasta completar tus pruebas de aceptación locales.
